...
NSString *const NotificationPollingStatusIdFormat = @"polling_status_%@";
...
NSString *const NotificationShowLoading = @"NotificationShowLoading";
NSString *const NotificationHideLoading = @"NotificationHideLoading";
