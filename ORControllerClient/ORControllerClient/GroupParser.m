...
@property (nonatomic, strong, readwrite) Group *group;
...
- (id)initWithRegister:(DefinitionElementParserRegister *)aRegister attributes:(NSDictionary *)attributeDict;
{
    ...
    if (self) {
        ...
        self.group = [[Group alloc] initWithGroupId:[[attributeDict objectForKey:ID] intValue] name:[attributeDict objectForKey:NAME]];
    }
    return self;
}
