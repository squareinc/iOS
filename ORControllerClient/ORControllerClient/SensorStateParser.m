...
@property (nonatomic, strong, readwrite) SensorState *sensorState;
...
- (id)initWithRegister:(DefinitionElementParserRegister *)aRegister attributes:(NSDictionary *)attributeDict
{
    ...
    if (self) {
        self.sensorState = [[SensorState alloc] initWithName:[attributeDict objectForKey:NAME] value:[attributeDict objectForKey:VALUE]];
    }
    return self;
}
