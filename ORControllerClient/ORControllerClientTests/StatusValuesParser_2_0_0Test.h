 ...
 * Data file used is SensorValuesValidResponse_2_0_0.xml, that is a copy from the one used as documentation in the Wiki at
 * http://openremote.org/display/docs/Controller+2.0+HTTP-REST-XML#Controller2.0HTTP-REST-XML-SensorPollingRequest
 *
 * Validates that:
 * - it does return the values as an NSDictionary
 * - the dictionary contains the correct number of sensors
